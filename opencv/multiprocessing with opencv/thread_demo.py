...
def threadVideoGet(source=0):
    '''
    Dedicated thread for grabbing video frames with VideoGet object. Main thread shows video frames
    '''
...
def threadVideoShow(source=0):
    '''
    Dedicated thread for showing video frames with VideoShow object. Main thread grabs video frames.
    '''
...
def threadBoth(source=0):
    '''
    Dedicated thread for grabbing video frames with VideoGet object. Dedicated thread for showing video frames with VideoShow object.
    Main thread serves only to pass frames between VideoGet and VideoShow objects/threads.
    '''
    video_getter = VideoGet(source).start()
